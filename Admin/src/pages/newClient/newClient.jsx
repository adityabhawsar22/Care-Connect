...
export default function NewClient() {
  ...
  return (
    ...
    <form className="newUserForm">
        ...
        <div className="newUserItem">
          <label>Phone</label>
          <input type="text" placeholder="+91 912356988" name="phone"  onChange={(e) => setPhone(e.target.value)}/>
        </div>
        <div className="newUserItem">
          <label>Address</label>
        ...
        <div className="newUserItem">
          ...
          <input type="text" placeholder="99856383930" name="adhaarNO"  onChange={(e) => setadhaarNo(e.target.value)} />
        </div>
        <div className="newUserItem">
