    ...
    <div className="newUser">
      ...
      <form className="newUserForm">
        <div className="newUserItem">
          ...
          <input type="text" placeholder="demo" name="username"  onChange={(e) => setUsername(e.target.value)}/>
        </div>
        <div className="newUserItem">
          <label>Full Name</label>
          <input type="text" placeholder="demo name" name="fullname"  onChange={(e) => setFullname(e.target.value)}/>
        </div>
        <div className="newUserItem">
          <label>Email</label>
          <input type="email" placeholder="demo@gmail.com" name="email" onChange={(e) => setEmail(e.target.value.replace(/\s/g, ''))} />
        </div>
        <div className="newUserItem">
          <label>Phone</label>
          <input type="text" placeholder="919684512542" name="phone"  onChange={(e) => setPhone(e.target.value.replace(/\s/g, ''))}/>
        </div>
        <div className="newUserItem">
          <label>Address</label>
          <input type="text" placeholder="Delhi | India" name="address"  onChange={(e) => setAdrress(e.target.value)} />
        </div>
        <div className="newUserItem">
          <label>Gender</label>
